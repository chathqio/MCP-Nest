...
const zod_schema_converter_1 = require("../../utils/zod-schema-converter");
        ...
        mcpServer.server.setRequestHandler(types_js_1.ListToolsRequestSchema, () => {
            const tools = this.registry.getTools(this.mcpModuleId).map((tool) => {
                ...
                if (tool.metadata.parameters) {
                    toolSchema['inputSchema'] = (0, zod_schema_converter_1.zodToJsonSchema)(tool.metadata.parameters);
                }
                if (tool.metadata.outputSchema) {
                    const outputSchema = (0, zod_schema_converter_1.zodToJsonSchema)(tool.metadata.outputSchema);
                    const jsonSchema = {
                        ...outputSchema,
                        type: 'object',
                    };
